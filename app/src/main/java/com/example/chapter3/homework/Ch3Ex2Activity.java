...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        animator2.setDuration(1000); animator2.setRepeatMode(ValueAnimator.REVERSE);
        ...
        ObjectAnimator alpha = ObjectAnimator.ofFloat(target, "alpha", 1.0f, 0.5f);
        alpha.setRepeatCount(ValueAnimator.INFINITE);
        alpha.setInterpolator(new LinearInterpolator());
        alpha.setDuration(1000); animator2.setRepeatMode(ValueAnimator.REVERSE);
        alpha.setRepeatMode(ValueAnimator.REVERSE);
        AnimatorSet animatorSet1 = new AnimatorSet();
        animatorSet1.playTogether(animator2, scaleYAnimator,alpha);
        animatorSet1.start();
